...
public class GameTest {
    ...
    public void testToJson() {
    	Game g = new Game("player_x","player_o");
    	g.setId("12345");
    	g.setGrid(new int[][]{{0,1,2},{2,1,0},{1,0,2}});
    	String jsonString = "{\"id\":\"12345\",\"dimension\":3,\"grid\":[[0,1,2],[2,1,0],[1,0,2]],\"status\":\"START\",\"winner\":0,\"lastUpdateTime\":" + g.getLastUpdateTime() +",\"playerNames\":[" +
				"\"player_x\","+
				"\"player_o\"" +"]}";
    ...
    public void testValidate() {
    	...
    	Game g2 = new Game("player_x","player_o");
    	g2.setId(g.getId());
    	g2.updateTime();
